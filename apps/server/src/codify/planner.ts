...
const INSTRUCTION = [
  ...
  "",
  "Most requests are ONE piece of work. Do not invent structure that is not",
  "there. Return the request unchanged as a single step unless it clearly asks",
  "for two different jobs.",
  "",
  "A second job is work a different person, team or system would do — almost",
  "always because it leaves the workspace. Sending mail, posting to a channel,",
  "filing a ticket, opening a pull request, deploying, notifying someone: those",
  "are second jobs.",
  "",
  "These are ONE step, however many clauses they have:",
  "- A result and the file it is written to. Auditing the dependencies and",
  "  writing the findings to ./reports/audit.md is one job: the file is the",
  "  output of the audit, not a task after it.",
  "- A deliverable and its shape: how it is broken down, what sections it has,",
  "  what format it is in, what it is sorted by.",
  "- Several things gathered into one document.",
  "",
  "Rules for a genuine split:",
